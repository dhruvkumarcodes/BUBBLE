        ...
        <div>
            <div className=" flex h-screen items-center justify-center">
                <form onSubmit={handleSubmit(onSubmit)} className='border border-black rounded-md p-6 max-w-sm bg-white shadow space-y-3 w-98'>
                    ...
                    <h1 className='text-2xl items-center font-semibold'>Login to your Account</h1>
                    ...
                    <div className='flex justify-center pr-4'>
                        ...
                        <input type="submit" value="Login" className='text-white bg-blue-500 w-[30vh] rounded-lg h-10 cursor-pointer'></input>
                    </div>
                    <h1>Don't have an account? <Link to="/signup" className='text-blue-500 cursor-pointer ml-1 '>Signup</Link></h1>
                </form>
